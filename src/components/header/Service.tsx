...
import workImage from "../../assets/services.svg";
...
const Service: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen p-8 bg-white flex flex-col items-center justify-center font-roboto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl p-4 md:p-8">
        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left p-4">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">
            <span className="text-green-500">
              {whyChooseUsTitle.split(" ")[0]}
            </span>{" "}
            <span className="text-black">{whyChooseUsTitle.split(" ")[1]}</span>
          </h2>
        ...
        <div className="flex justify-center items-center p-4">
          <img
            ...
            className="w-full h-auto max-w-xs md:max-w-md animate-zoomInOut"
          />
        </div>
      </div>
